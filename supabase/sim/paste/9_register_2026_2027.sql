...
--
-- TWO YEARS OF ONE SCHOOL'S USE. FILE 9 OF 13: register 2026 2027
--
-- This year's register up to today, with today deliberately left unfinalised the way a real one is at eleven in the morning. Then the staff register, the gate codes, and twenty finalised days reopened and corrected the way a school corrects one: a father turns up with the leave application. Under a minute.
--
