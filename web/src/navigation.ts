...
export const NAV: NavItem[] = [
  ...
  { path: '/accounts', label: 'Accounts', roles: ['owner', 'principal', 'accountant'], blurb: 'Expenses, non-fee income, and the profit figure. Fee income is derived from receipts and never typed in.' },
  ...
  { path: '/birthdays', label: 'Birthdays', roles: ['owner', 'principal', 'admin_clerk', 'class_teacher'], blurb: "Children and staff with a birthday today or soon, with a WhatsApp wish." },
